...
class DailyQuestion202312 {
    ...
    public static void main(String[] args) {
        ...
        minStoneSumTest(dq);
        StringUtils.divisionLine();
        minimumMountainRemovalsTest(dq);
        StringUtils.divisionLine();
        numOfBurgersTest(dq);
        StringUtils.divisionLine();
        isWinnerTest(dq);
    ...
    private static void numOfBurgersTest(DailyQuestion202312 dq) {
        System.out.println(dq.numOfBurgers(16, 7));
        System.out.println(dq.numOfBurgers(17, 4));
        System.out.println(dq.numOfBurgers(4, 17));
        System.out.println(dq.numOfBurgers(0, 0));
        System.out.println(dq.numOfBurgers(2, 1));
    }
    ...
    private static void minimumMountainRemovalsTest(DailyQuestion202312 dq) {
        System.out.println(dq.minimumMountainRemovals(new int[]{1, 3, 1}));
        System.out.println(dq.minimumMountainRemovals(new int[]{2, 1, 1, 5, 6, 2, 3, 1}));
        System.out.println(dq.minimumMountainRemovals(StringUtils.randomIntArray(1000, 1, 100000)));
    }
